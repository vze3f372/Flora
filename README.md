...
Run the Flora server and open `http://127.0.0.1:8000/admin.html` to edit follower/subscriber goal values, adjust panel colors, configure panel rotation, and copy OBS or Streamer.bot URLs without manually editing JSON files.
